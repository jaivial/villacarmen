...
?>
        ...
        <?php
            ...
            $consulta = "UPDATE FINDE SET DESCRIPCION = '{$texto}' WHERE NUM = '{$formID}';";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['eliminaplato'])) {
        ...
        $consulta = "DELETE FROM FINDE WHERE NUM = '{$formID}';";
        if (!$resultado = $mysqli->query($consulta)) {
            echo "Lo sentimos. App falla<br>";
            echo "Error en $consulta <br>";
            echo "Num.error: " . $mysqli->errno . "<br>";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['anyadeEntrante'])) {
        ...
        <?php
            ...
            $consulta = "INSERT INTO FINDE (DESCRIPCION, TIPO) VALUE ('{$texto}', 'ENTRANTE');";
            if (!$resultado = $mysqli->query($consulta)) {
                echo "Lo sentimos. App falla<br>";
                echo "Error en $consulta <br>";
                echo "Num.error: " . $mysqli->errno . "<br>";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['anyadePrincipal'])) {
        ...
        <?php
            ...
            $consulta = "INSERT INTO FINDE (DESCRIPCION, TIPO) VALUE ('{$texto}', 'PRINCIPAL');";
            if (!$resultado = $mysqli->query($consulta)) {
                echo "Lo sentimos. App falla<br>";
                echo "Error en $consulta <br>";
                echo "Num.error: " . $mysqli->errno . "<br>";
...
<?php
            ...
            $consulta = "INSERT INTO FINDE (DESCRIPCION, TIPO) VALUE ('{$texto}', 'ARROZ');";
            if (!$resultado = $mysqli->query($consulta)) {
                echo "Lo sentimos. App falla<br>";
                echo "Error en $consulta <br>";
                echo "Num.error: " . $mysqli->errno . "<br>";
